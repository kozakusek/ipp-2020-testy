...
*/
gamma_t* board = gamma_new(8, 4, 9, 3);
assert( board != NULL );
...
char* board503634303 = gamma_board(board);
assert( board503634303 != NULL );
assert( strcmp(board503634303, 
"..5.....\n"
".243....\n"
".4......\n"
"....3...\n") == 0);
...
char* board297864864 = gamma_board(board);
assert( board297864864 != NULL );
assert( strcmp(board297864864, 
".8597...\n"
".243....\n"
"94...8..\n"
"...73.1.\n") == 0);
...
char* board318977139 = gamma_board(board);
assert( board318977139 != NULL );
assert( strcmp(board318977139, 
".8597.7.\n"
".243945.\n"
"9413.826\n"
"51273.11\n") == 0);
