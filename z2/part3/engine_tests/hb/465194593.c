...
assert( gamma_move(board, 5, 0, 25) == 1 );
...
assert( gamma_move(board, 5, 0, 44) == 1 );
...
assert( gamma_move(board, 8, 0, 42) == 1 );
...
assert( gamma_golden_move(board, 1, 1, 52) == 0 );
...
assert( gamma_move(board, 6, 0, 31) == 1 );

assert( gamma_move(board, 7, 0, 4) == 0 );

assert( gamma_move(board, 8, 0, 34) == 1 );
...
assert( gamma_golden_move(board, 8, 1, 13) == 0 );
