...
gamma_t* board = gamma_new(1, 54, 8, 4);
...
assert( gamma_move(board, 8, 0, 40) == 1 );
...
assert( gamma_move(board, 1, 0, 49) == 1 );
...
assert( gamma_move(board, 8, 0, 54) == 0 );
...
assert( gamma_golden_move(board, 1, 1, 34) == 0 );
...
assert( gamma_golden_move(board, 8, 0, 24) == 0 );
