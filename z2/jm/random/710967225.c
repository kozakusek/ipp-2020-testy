...
*/
gamma_t* board = gamma_new(5, 11, 8, 9);
assert( board != NULL );
...
char* board892978700 = gamma_board(board);
assert( board892978700 != NULL );
assert( strcmp(board892978700, 
"...47\n"
".....\n"
".....\n"
".....\n"
...
char* board866070853 = gamma_board(board);
assert( board866070853 != NULL );
assert( strcmp(board866070853, 
"17647\n"
"18...\n"
"...72\n"
"..385\n"
...
char* board388784463 = gamma_board(board);
assert( board388784463 != NULL );
assert( strcmp(board388784463, 
"17647\n"
"18...\n"
"...72\n"
"..385\n"
...
char* board685543263 = gamma_board(board);
assert( board685543263 != NULL );
assert( strcmp(board685543263, 
"17647\n"
"18838\n"
".7872\n"
"2.385\n"
